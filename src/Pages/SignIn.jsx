...
const SignIn = () => {
  ...
  return (
    ...
    <form onSubmit={handleSubmit}>
      ...
      <button type="submit" disabled={!isValid} style={{ backgroundColor:"rgba(2, 28, 110, 1)",  border:"rgba(2, 28, 110, 1)"}}>
        Login</button>  {/* Disable if invalid */}
         <div>
            <p>Don't have an Account? <Link to="/RegistrationForm"><span style={{fontWeight:"500",  textDecoration:"none"}}>Create</span></Link></p>
        </div>
        </form>
